...
public class BluetoothEventManager {
    ...
    BluetoothEventManager(LocalBluetoothAdapter adapter,
        ...
        mProfileIntentFilter.setPriority(Integer.MAX_VALUE);
        mAdapterIntentFilter.setPriority(Integer.MAX_VALUE);
        ...
        addHandler(BluetoothDevice.ACTION_PAIRING_REQUEST, new PairingRequestHandler());
    ...
    private class PairingRequestHandler implements Handler {
        @Override
                ...
                switch (type) {
                    ...
                    case BluetoothDevice.PAIRING_VARIANT_PASSKEY:
                        ...
                        synchronized (mCallbacks) {
                            for (BluetoothCallback callback : mCallbacks) {
                                callback.onPairingRequestNeedInput(cachedDevice, type);
                            }
                        }
                        break;
                    case BluetoothDevice.PAIRING_VARIANT_PASSKEY_CONFIRMATION:
                        /*int passkey = intent.getIntExtra(BluetoothDevice.EXTRA_PAIRING_KEY,
                                BluetoothDevice.ERROR);
                        String pairingKey = String.format(Locale.US, "%06d", passkey);*/
                    ...
                    case BluetoothDevice.PAIRING_VARIANT_DISPLAY_PIN:
                        ...
                        String format = String.format("%04d", pairingKey);
                        byte[] pinBytes = BluetoothDevice.convertPinToBytes(format);
    ...
    public static void setPasskey(BluetoothDevice device, int passkey) {
    ...
    private class PairingCancelHandler implements Handler {
        public void onReceive(Context context, Intent intent, BluetoothDevice device) {
            ...
            synchronized (mCallbacks) {
                for (BluetoothCallback callback : mCallbacks) {
                    callback.onPairingCancel(cachedDevice);
                }
            }
        }
    }
