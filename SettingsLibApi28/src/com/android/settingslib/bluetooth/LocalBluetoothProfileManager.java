...
public class LocalBluetoothProfileManager {
    ...
    public interface OnA2dpSinkProfileInitListener {
        void onA2dpSinkProfileInit();
    }

    public interface OnHfpClientProfileInitListener {
        void onHfpClientProfileInit();
    }

    private OnA2dpSinkProfileInitListener onA2dpSinkProfileInitListener;
    private OnHfpClientProfileInitListener onHfpClientProfileInitListener;
    private boolean a2dpProfilesInitialized = false;
    private boolean hfpClientProfilesInitialized = false;

    public boolean isHfpClientProfilesInitialized() {
        return hfpClientProfilesInitialized;
    }

    public boolean isA2dpSkinProfilesInitialized() {
        return a2dpProfilesInitialized;
    }

    public void setOnA2dpSinkProfileInitListener(OnA2dpSinkProfileInitListener listener) {
        this.onA2dpSinkProfileInitListener = listener;
    }

    public void setOnHfpClientProfileInitListener(OnHfpClientProfileInitListener listener) {
        this.onHfpClientProfileInitListener = listener;
    }
    ...
    void updateLocalProfiles(ParcelUuid[] uuids) {
        ...
        if (BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.AudioSink)) {
            if (mA2dpSinkProfile == null) {
                ...
                a2dpProfilesInitialized = true;
                if (onA2dpSinkProfileInitListener != null) {
                    onA2dpSinkProfileInitListener.onA2dpSinkProfileInit();
                }
            }
        ...
        if (BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.Handsfree)) {
            if (mHfpClientProfile == null) {
                ...
                hfpClientProfilesInitialized = true;
                if (onHfpClientProfileInitListener != null) {
                    onHfpClientProfileInitListener.onHfpClientProfileInit();
                }
            }
    ...
    void setBluetoothStateOn() {
        ...
        mEventManager.readPairedDevices();  //只有一个列表,并不需要配对过的设备的记录
    }
